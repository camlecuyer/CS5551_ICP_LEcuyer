...
var tutorial = angular.module('starter', ['ionic', 'ngCordova', 'firebase']);

tutorial.run(function ($ionicPlatform) {
...
tutorial.controller("FirebaseController", function ($scope, $state, $firebaseAuth) {
...
tutorial.controller("SecureController", function ($scope, $ionicHistory, $firebaseObject, $firebaseArray, $firebaseAuth, $cordovaCamera, $state) {
